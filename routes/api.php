...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/cashier-shifts/my-shifts',         [CashierShiftController::class, 'myShifts']);
    Route::get('/cashier-shifts/my-summary/{shift}',[CashierShiftController::class, 'myShiftSummary']);
